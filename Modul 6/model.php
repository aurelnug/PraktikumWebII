    ...
    if (!empty($result)) {
        if ($nama_tabel == "member") {
            foreach ($result as $row) {
                ...
                echo "<td>";
                echo "<a href='FormMember.php?id_member=" . $row['id_member'] . "'><button style='background-color:#f57f17; border: none; color:white; border-radius: 5px; width: 50px; height: 20px'>Edit</button></a>";
                echo " | ";
                echo "<a href='Member.php?id_member=" . $row['id_member'] . "' onclick=\"return confirm('Yakin Hapus?')\"><button style='background-color:red; border: none; color:white; border-radius: 5px; width: 50px; height: 20px'>Hapus</button></a>";
                echo "</td>";
                echo "</tr>";
            }
            ...
            foreach ($result as $row) {
                ...
                echo "<td>";
                echo "<a href='FormBuku.php?id_buku=" . $row['id_buku'] . "'><button style='background-color:#f57f17; border: none; color:white; border-radius: 5px; width: 50px; height: 20px'>Edit</button></a>";
                echo " | ";
                echo "<a href='Buku.php?id_buku=" . $row['id_buku'] . "' onclick=\"return confirm('Yakin Hapus?')\"><button style='background-color:red; border: none; color:white; border-radius: 5px; width: 50px; height: 20px'>Hapus</button></a>";
                echo "</td>";
                echo "</tr>";
            }
            ...
            foreach ($result as $row) {
                ...
                echo "<td>";
                echo "<a href='FormPeminjaman.php?id_peminjaman=" . $row['id_peminjaman'] . "'><button style='background-color:#f57f17; border: none; color:white; border-radius: 5px; width: 50px; height: 20px'>Edit</button></a>";
                echo " | ";
                echo "<a href='Peminjaman.php?id_peminjaman=" . $row['id_peminjaman'] . "' onclick=\"return confirm('Yakin Hapus?')\"><button style='background-color:red; border: none; color:white; border-radius: 5px; width: 50px; height: 20px'>Hapus</button></a>";
                echo "</td>";
                echo "</tr>";
            }
        }
