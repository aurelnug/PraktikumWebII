...
<body>
    ...
    <form action=" " method="post">
        ...
        <?php if (isset($suhuAwal) && $suhuAwal == "Celcius") echo "checked"; ?>
            value="Celcius"> Celcius <br>
        <input type="radio" name="suhuAwal" 
        <?php if (isset($suhuAwal) && $suhuAwal == "Fahrenheit") echo "checked"; ?>
            value="Fahrenheit"> Fahrenheit <br>
        <input type="radio" name="suhuAwal" 
        <?php if (isset($suhuAwal) && $suhuAwal == "Rheamur") echo "checked"; ?>
            value="Rheamur"> Rheamur <br>
        <input type="radio" name="suhuAwal" 
        <?php if (isset($suhuAwal) && $suhuAwal == "Kelvin") echo "checked"; ?>
            value="Kelvin"> Kelvin <br>

        Ke : <br>
        <input type="radio" name="suhuAkhir" 
        <?php if (isset($suhuAkhir) && $suhuAkhir == "Celcius") echo "checked"; ?>
            value="Celcius"> Celcius <br>
        <input type="radio" name="suhuAkhir"
        <?php if (isset($suhuAkhir) && $suhuAkhir == "Fahrenheit") echo "checked"; ?> 
            value="Fahrenheit"> Fahrenheit<br>
        <input type="radio" name="suhuAkhir" 
        <?php if (isset($suhuAkhir) && $suhuAkhir == "Rheamur") echo "checked"; ?>
            value="Rheamur"> Rheamur <br>
        <input type="radio" name="suhuAkhir" 
        <?php if (isset($suhuAkhir) && $suhuAkhir == "Kelvin") echo "checked"; ?>
            value="Kelvin"> Kelvin <br>
